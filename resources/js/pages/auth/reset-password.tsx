...
export default function ResetPassword({ token, email }: ResetPasswordProps) {
    ...
    return (
        <AuthLayout
            title={t('Şifreni sıfırla', 'Reset password')}
            description={t('Yeni şifreni aşağıya gir.', 'Please enter your new password below.')}
        >
            <Head title={t('Şifreyi Sıfırla', 'Reset Password')} />
